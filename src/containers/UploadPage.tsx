...
import { arrayBufferToBase64 } from '../eosfilestore/utils'
        ...
        <div className="txid row rowspace start-xs">
          <div className="col-xs-offset-1 col-xs-9">
            <div className="mybox box">
              ...
              <p>
                Here you can update your avatar image attached to your EOS account. 
                <br />You need at least 60000bytes free of RAM, try it first with a small image (~2kb).
              </p>
              <FileInput
                large={true}
